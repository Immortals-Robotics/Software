...
void ai09::tech_mexico ( void )
{
	...
	Navigate2Point ( rn   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
	...
	Navigate2Point ( rn+1   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
	...
	Navigate2Point ( rn+2   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
	...
	Navigate2Point ( rn+3   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
	...
	Navigate2Point ( rn+4   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
	...
	Navigate2Point ( rn+5   , Vec2 (  1500+hhh*0.0f , 00+hhh*1400.0 ) , 0 , 100 );
