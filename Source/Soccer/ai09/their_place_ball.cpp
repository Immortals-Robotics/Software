...
void ai09::their_place_ball ( void ){
    ...
    ERRTSetObstacles ( dmf , false , true , true , false );
    ...
    ERRTSetObstacles ( rw , false , true , true , false );
    AddCircle ( ball.Position.X , ball.Position.Y , 1010.0f );
    AddCircle ( targetBallPlacement->X , targetBallPlacement->Y , 1010.0f );
    for ( int i = 0 ; i < MAX_ROBOTS ; i ++ )
    {
    ...
    ERRTSetObstacles ( lw , false , true , true , false );
    AddCircle ( ball.Position.X , ball.Position.Y , 1010.0f );
    AddCircle ( targetBallPlacement->X , targetBallPlacement->Y , 1010.0f );
    for ( int i = 0 ; i < MAX_ROBOTS ; i ++ )
    {
    ...
    ERRTSetObstacles ( lmf , false , true , true , false );
    AddCircle ( ball.Position.X , ball.Position.Y , 1010.0f );
    AddCircle ( targetBallPlacement->X , targetBallPlacement->Y , 1010.0f );
    for ( int i = 0 ; i < MAX_ROBOTS ; i ++ )
    {
    ...
    ERRTSetObstacles ( rmf , false , true , true , false );
    AddCircle ( ball.Position.X , ball.Position.Y , 1010.0f );
    AddCircle ( targetBallPlacement->X , targetBallPlacement->Y , 1010.0f );
    for ( int i = 0 ; i < MAX_ROBOTS ; i ++ )
    {
    ...
    ERRTSetObstacles ( cmf , false , true , true , false );
    AddCircle ( ball.Position.X , ball.Position.Y , 1010.0f );
    AddCircle ( targetBallPlacement->X , targetBallPlacement->Y , 1010.0f );
    for ( int i = 0 ; i < MAX_ROBOTS ; i ++ )
    {
