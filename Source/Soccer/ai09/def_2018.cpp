...
void ai09::DefBy1(int thelastdef_num, TVec2 *defendTarget, bool stop){
    ...
    if (thelastdef_num != -1)
    {
        ...
        } else if (alpha > 85.0)
        {
            ...
            ERRTSetObstacles(thelastdef_num, stop, 1, 1, 0);
...
void ai09::DefBy2(int rightdef_num ,int leftdef_num, TVec2 * defendTarget , bool stop){
    ...
    if (rightdef_num != -1)
    {
        ...
        if (alpha < -85.0)
        {
            ...
            ERRTSetObstacles(rightdef_num, stop, 1, 1, 0);
...
//            runningDef(rightdef_num, target, defendTarget, stop);
    ...
    if (leftdef_num != -1)
    {
        ...
        if (alpha > 85.0)
        {
            ...
            ERRTSetObstacles(leftdef_num, stop, 1, 1, 0);
...
//            TVec2 target = Vec2(ans.getX(), ans.getY());
        ...
        } else
        {
            ...
            ERRTSetObstacles(middef_num, stop, 1, 1, 0);
